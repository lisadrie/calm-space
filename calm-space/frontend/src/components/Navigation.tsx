            ...
            {decoded ? (
              <>
                {decoded.role === 'Super Admin' && (
                  <Link to="/admin">
                    <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-sm font-medium text-purple-700 bg-purple-50 hover:bg-purple-100 border border-purple-200 transition-colors">
            ...
            <div className="border-t border-purple-100/60 pt-2 mt-1">
              {decoded ? (
                <>
                  {decoded.role === 'Super Admin' && (
                    <Link to="/admin">
                      <div className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-purple-700 bg-purple-50 hover:bg-purple-100 rounded-xl">
